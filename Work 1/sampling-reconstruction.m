...
%Parte da onda sineoidal finita
xsig_infinite=sin(2*1*pi*t)-sin(2*3*pi*t); % seno de 1Hz + 3Hz
finite = heaviside(t-0.125)-heaviside(t-0.875); %Multiplicador para tornar senoide finita: U(t-0.125)-U(t-875). Valores escolhidos onde a senoide era 0, pq U(0)=1/2;
xsig = xsig_infinite.*finite; %Multplicando onda infinita com o "Filtro".
%fim da senoidal finita
...
axis([-100 100 0 2000/fator]);%Alteado de -150 150 300 para -200 200 500  para ver a onda
